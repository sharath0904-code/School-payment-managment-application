...
public class Main {
	...
	public static void main(String[] args) {
		...
		tammana.paysFees(60000);
		radha.paysFees(50000);
		...
		Vijay.receiveSalary(Vijay.getSalary());
		System.out.println(
				"School has spent for salary to " + Vijay.getName() + " and now has Rs."
